...
RegisterNetEvent('qbr-shops:client:SetShopItems', function(shopType, shopProducts)
    Config.Products[shopType] = shopProducts
end)

RegisterNetEvent('qbr-shops:client:RestockShopItems', function(shopType, amount)
